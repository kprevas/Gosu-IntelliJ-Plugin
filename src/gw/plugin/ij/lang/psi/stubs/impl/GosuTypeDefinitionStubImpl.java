 ...
 */
public class GosuTypeDefinitionStubImpl extends StubBase<GosuTypeDefinition> implements GosuTypeDefinitionStub
{
  ...
  public static byte buildFlags( GosuTypeDefinition typeDefinition )
  {
    byte flags = 0;
    if( typeDefinition.isAnonymous() )
    {
      flags |= ANONYMOUS;
      if( ((GosuAnonymousClassDefinition)typeDefinition).isInQualifiedNew() )
      {
